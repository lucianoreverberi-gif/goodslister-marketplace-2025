  ...
  try {
    ...
    await sql`
      UPDATE listings SET 
        ...
        price_unit = ${listing.priceUnit}, deposit_amount = ${listing.securityDeposit || 0}, item_value = ${listing.item_value || 0}, license_required = ${listing.licenseRequired || false}, license_type = ${listing.licenseType || null}
      WHERE id = ${listing.id}
    `;
