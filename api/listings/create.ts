  ...
  try {
    ...
    await sql`
      INSERT INTO listings (
        ...
        price_unit, deposit_amount, item_value, brand, model, full_address,
        license_required, license_type
      ) VALUES (
        ...
        ${listing.priceUnit}, ${listing.securityDeposit || 0}, ${listing.item_value || 0}, ${listing.brand || null}, ${listing.model || null}, ${listing.fullAddress || null},
        ${listing.licenseRequired || false}, ${listing.licenseType || null}
      )
    `;
