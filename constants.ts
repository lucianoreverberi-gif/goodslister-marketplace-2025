...
export const mockUsers: User[] = [
    {
        id: 'user-1',
        name: 'Carlos Gomez',
        email: 'carlos.demo@goodslister.com',
    ...
    },
    {
        id: 'user-2',
        name: 'Ana Rodriguez',
        email: 'ana.demo@goodslister.com',
...
export const mockListings: Listing[] = [
    {
        ...
        pricingType: 'daily',
        pricePerDay: 50,
        location: { city: 'Key West', state: 'Florida', country: 'USA', latitude: 24.5551, longitude: -81.7800 },
        owner: mockUsers[0],
    ...
    },
    {
        ...
        pricingType: 'daily',
        pricePerDay: 60,
        location: { city: 'Orlando', state: 'Florida', country: 'USA', latitude: 28.5383, longitude: -81.3792 },
        owner: mockUsers[1],
    ...
    },
    {
        ...
        pricingType: 'daily',
        pricePerDay: 75,
        location: { city: 'Tampa', state: 'Florida', country: 'USA', latitude: 27.9506, longitude: -82.4572 },
        owner: mockUsers[0],
    ...
    },
    {
        ...
        pricingType: 'daily',
        pricePerDay: 150,
        location: { city: 'Fort Lauderdale', state: 'Florida', country: 'USA', latitude: 26.1224, longitude: -80.1373 },
        owner: mockUsers[1],
    ...
    },
     {
        ...
        pricingType: 'hourly',
        pricePerHour: 25,
        location: { city: 'St. Petersburg', state: 'Florida', country: 'USA', latitude: 27.7676, longitude: -82.6403 },
        owner: mockUsers[0],
