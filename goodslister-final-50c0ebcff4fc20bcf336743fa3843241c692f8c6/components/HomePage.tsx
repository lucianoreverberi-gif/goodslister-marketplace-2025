        ...
        <main>
            ...
            <div id="how-it-works" className="bg-white py-16 sm:py-24">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        {howItWorksTab === 'renter' ? (
                            <>
                                <div className="flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    <div className="bg-cyan-100 text-cyan-600 rounded-full p-4 mb-4"><SearchIcon className="h-8 w-8" /></div>
                                ...
                                <div className="flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
                                    <div className="bg-cyan-100 text-cyan-600 rounded-full p-4 mb-4"><ShieldCheckIcon className="h-8 w-8" /></div>
                                ...
                                <div className="flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
                                    <div className="bg-cyan-100 text-cyan-600 rounded-full p-4 mb-4"><SmileIcon className="h-8 w-8" /></div>
                            ...
                            <>
                                <div className="flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500">
                                    <div className="bg-green-100 text-green-600 rounded-full p-4 mb-4"><UploadCloudIcon className="h-8 w-8" /></div>
                                ...
                                <div className="flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
                                    <div className="bg-green-100 text-green-600 rounded-full p-4 mb-4"><MessageSquareIcon className="h-8 w-8" /></div>
                                ...
                                <div className="flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
                                    <div className="bg-green-100 text-green-600 rounded-full p-4 mb-4"><WalletIcon className="h-8 w-8" /></div>
                    ...
                    <div className="mt-12">
                        <a href="/how-it-works" onClick={(e) => handleGridLinkClick(e, 'howItWorks')} className="text-cyan-600 hover:text-cyan-800 font-semibold hover:underline">Learn more details &rarr;</a>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gray-50 py-16 sm:py-24">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="mt-20 flex flex-wrap justify-center gap-8">
                        <div onClick={() => document.getElementById('hero-search-input')?.focus()} className="flex flex-col items-center text-center cursor-pointer group hover:bg-blue-50 p-6 rounded-xl transition-all duration-300 hover:scale-105 w-full sm:w-72">
                            <div className="bg-blue-100 text-blue-600 rounded-full p-4 mb-6 group-hover:bg-blue-200 transition-colors"><BrainIcon className="h-10 w-10" /></div>
                        ...
                        <a href="/ai-assistant" onClick={(e) => handleGridLinkClick(e, 'aiAssistant')} className="flex flex-col items-center text-center cursor-pointer group hover:bg-blue-50 p-6 rounded-xl transition-all duration-300 hover:scale-105 w-full sm:w-72">
                            <div className="bg-blue-100 text-blue-600 rounded-full p-4 mb-6 group-hover:bg-blue-200 transition-colors"><FileSignatureIcon className="h-10 w-10" /></div>
                        ...
                        <a href="/create-listing" onClick={(e) => handleGridLinkClick(e, 'createListing')} className="flex flex-col items-center text-center cursor-pointer group hover:bg-blue-50 p-6 rounded-xl transition-all duration-300 hover:scale-105 w-full sm:w-72">
                            <div className="bg-blue-100 text-blue-600 rounded-full p-4 mb-6 group-hover:bg-blue-200 transition-colors"><ZapIcon className="h-10 w-10" /></div>
                        ...
                        <a href="/explore" onClick={(e) => handleGridLinkClick(e, 'explore')} className="flex flex-col items-center text-center cursor-pointer group hover:bg-blue-50 p-6 rounded-xl transition-all duration-300 hover:scale-105 w-full sm:w-72">
                            <div className="bg-blue-100 text-blue-600 rounded-full p-4 mb-6 group-hover:bg-blue-200 transition-colors"><GlobeIcon className="h-10 w-10" /></div>
                        ...
                        <a href="/dashboard" onClick={(e) => handleGridLinkClick(e, 'userDashboard')} className="flex flex-col items-center text-center cursor-pointer group hover:bg-blue-50 p-6 rounded-xl transition-all duration-300 hover:scale-105 w-full sm:w-72">
                            <div className="bg-blue-100 text-blue-600 rounded-full p-4 mb-6 group-hover:bg-blue-200 transition-colors"><ScanIcon className="h-10 w-10" /></div>
                        ...
                        {/* STAR FEATURE: AI Identity Guard */}
                        <a href="/ai-assistant" onClick={(e) => handleGridLinkClick(e, 'aiAssistant')} className="flex flex-col items-center text-center cursor-pointer group hover:bg-blue-50 p-6 rounded-xl transition-all duration-300 hover:scale-105 w-full sm:w-72">
                            <div className="bg-blue-100 text-blue-600 rounded-full p-4 mb-6 group-hover:bg-blue-200 transition-colors"><UserCheckIcon className="h-10 w-10" /></div>
                            <h3 className="text-xl font-semibold text-gray-900 group-hover:text-blue-700">AI Identity Guard</h3>
                            <p className="text-base text-gray-600">Seguridad de nivel bancario. Nuestra IA escanea y verifica identificaciones oficiales en segundos para eliminar el fraude y garantizar tu tranquilidad.</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-12 text-left">
                        <div className="flex flex-col items-center text-center">
                            <div className="bg-green-100 text-green-600 rounded-full p-4 mb-4"><UserCheckIcon className="h-8 w-8" /></div>
                        ...
                        <div className="flex flex-col items-center text-center">
                            <div className="bg-green-100 text-green-600 rounded-full p-4 mb-4"><MessageCircleIcon className="h-8 w-8" /></div>
