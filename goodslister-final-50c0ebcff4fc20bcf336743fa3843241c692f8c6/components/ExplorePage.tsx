...
import { SearchIcon, MapPinIcon, LocateIcon, LayoutDashboardIcon, TagIcon, DollarSignIcon } from './icons';
...
const ExplorePage: React.FC<ExplorePageProps> = ({ listings, onListingClick, initialFilters, onClearInitialFilters, favorites, onToggleFavorite }) => {
    ...
    return (
        <div className="flex flex-col md:flex-row h-[calc(100vh-64px)] overflow-hidden relative">
            ...
            >
                <div className="flex-shrink-0 bg-gray-50 border-b overflow-y-auto max-h-[55vh] lg:max-h-none">
                        ...
                        <div className="bg-white p-5 rounded-3xl border border-gray-100 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex justify-between items-center pt-1">
                                    <span className="text-[9px] font-bold text-gray-400 uppercase">Min: ${minPrice}</span>
                                    <span className="text-[9px] font-bold text-gray-400 uppercase">Max: ${maxPrice}</span>
                                </div>
                            </div>
                        </div>
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-white">
                    {isLoadingListings ? (
                        ...
                        <div className="text-center py-20">
                            ...
                            <p className="mt-2 text-gray-500 text-sm max-w-[250px] mx-auto leading-relaxed">Adjust your filters or try another location.</p>
                        </div>
                    )}
                </div>
            </div>
