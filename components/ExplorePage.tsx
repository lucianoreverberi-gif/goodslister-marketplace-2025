...
const ExplorePage: React.FC<ExplorePageProps> = ({ listings, onListingClick }) => {
    ...
    useEffect(() => {
        if (mapRef.current && filteredAndSortedListings.length > 0) {
            ...
            // Prevent zooming in too far if there's only one result
