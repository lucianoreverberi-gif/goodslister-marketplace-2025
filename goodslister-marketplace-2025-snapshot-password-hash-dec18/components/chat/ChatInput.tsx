...
const ChatInput: React.FC<ChatInputProps> = ({ onSendMessage, disabled }) => {
  ...
  return (
    <form 
      ...
      className="p-3 md:p-4 bg-white border-t border-gray-100 flex items-end gap-2"
    >
      <button 
        type="button"
      ...
      <div className="flex-1 bg-gray-100 rounded-2xl flex items-center px-4 py-2 focus-within:ring-2 focus-within:ring-indigo-100 transition-all">
        <input 
          ...
          disabled={disabled}
          className="flex-1 bg-transparent border-none focus:ring-0 text-sm text-slate-800 placeholder-slate-400 max-h-32"
        />
