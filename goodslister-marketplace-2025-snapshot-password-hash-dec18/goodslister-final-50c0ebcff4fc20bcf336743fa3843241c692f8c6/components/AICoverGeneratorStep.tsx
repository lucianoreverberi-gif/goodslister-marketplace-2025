...
import { WandSparklesIcon, CheckCircleIcon, AlertIcon, LightbulbIcon, TagIcon, PaletteIcon, LockIcon } from './icons';
...
const AICoverGeneratorStep: React.FC<AICoverGeneratorStepProps> = ({ realPhotoCount, onImageGenerated }) => {
