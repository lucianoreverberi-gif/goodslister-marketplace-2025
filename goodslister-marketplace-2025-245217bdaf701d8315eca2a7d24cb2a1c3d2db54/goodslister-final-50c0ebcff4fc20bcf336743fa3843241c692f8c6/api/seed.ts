        ...
        if (ownerExists) {
             await sql`
                INSERT INTO listings (
                    ...
                    owner_id, images, video_url, is_featured, is_instant_book, rating, reviews_count, booked_dates, owner_rules, 
                ...
                VALUES (
                    ...
                    ${listing.owner.id}, ${listing.images as any}, ${listing.videoUrl || ''}, ${listing.isFeatured}, ${listing.isInstantBook || false}, ${listing.rating}, ${listing.reviewsCount}, ${listing.bookedDates as any}, ${listing.ownerRules || ''}, 
